...
public class RocketMQBroadcastingConsumerServiceTestA {
            ...
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext consumeConcurrentlyContext) {
                ...
                for (MessageExt msg : msgs) {
                    try {
                        ...
                        System.out.println("A-------Consumer消费信息: topic" + topic + " , tags: " + tags + " ,result: " + result + " , reconsumeTimes: " + reconsumeTimes);
